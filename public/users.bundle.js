...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2.default.getJSON(host + "users/" + account + "/channels", function (data, status) {
	    if (status != "success") {
	        alert(data.id);
	        return;
	    }
	    ...
	    (0, _jquery2.default)(".container").html(containerHtml);
	}).catch(function (e) {
	    (0, _jquery2.default)(".container").text("没有找到该用户！");
	});
