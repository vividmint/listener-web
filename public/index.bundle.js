...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2.default.getJSON(host + "users/" + account + "/timelines?limit=" + limit + "&start=" + start, function (data, status) {
	    if (status != "success") {
	        alert(data.id);
	        return;
	    }
	    ...
	    if (data.list.length > 0) {
	        ...
	        (0, _jquery2.default)(".list").html(listHtml);
	        (0, _jquery2.default)(".more").removeClass("disable");
	    } else {
	        (0, _jquery2.default)(".list").text("目前没有新主题");
	    }
	});

	(0, _jquery2.default)(".more").on("click", function () {
	    _jquery2.default.getJSON(host + "users/" + account + "/timelines?limit=" + limit + "&start=" + start, function functionName(data) {
	        console.log(data);
	        if (data.list.length > 0) {
	            var listHtml = '';
	            for (var i = 0; i < data.list.length; i++) {
	            ...
	            start = start + data.list.length;
	            (0, _jquery2.default)(".list").append(listHtml);
	            (0, _jquery2.default)(".more").removeClass("disable");
	        } else {
	            (0, _jquery2.default)(".more").addClass("disable");
	            (0, _jquery2.default)(".hasMore").append("<div class = \"noMore\">没有更多了</div>");
	            // console.log("b")
	        }
	    });
	});

	(0, _jquery2.default)(".container").on("click", ".sub", function (e) {
	    var id = (0, _jquery2.default)(e.target).parent().parent().parent().attr("id");
	    (0, _jquery2.default)(e.target).html('<i class="fa fa-spinner fa-spin fa-fw"></i>');
	    var isSub = (0, _jquery2.default)(e.target).hasClass("button-active");
	    console.log(isSub);
	    if (isSub) {
	        (0, _common.request)("channels/" + id + "/subscriptions", "delete", {
	            "user_id": account
	        }).then(function (data) {
	            (0, _jquery2.default)(e.target).removeClass("button-active");
	            (0, _jquery2.default)(e.target).text("+ 监听");
	            console.log(data);
	        }).catch(function (error) {
	            console.log(error);
	        });
	    } else {
	        (0, _common.request)("channels/" + id + "/subscriptions", "post", {
	            "user_id": account,
	            "allow_push": true
	        }).then(function (data) {
	            (0, _jquery2.default)(e.target).addClass("button-active");
	            (0, _jquery2.default)(e.target).text("√ 已监听");
	            console.log(data);
	        }).catch(function (error) {
	            console.log(error);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    function lib$es6$promise$asap$$attemptVertx() {
	      try {
	        var r = require;
	        var vertx = __webpack_require__(297);
	    ...
	    */
	    ...
	    if ("function" === 'function' && __webpack_require__(298)['amd']) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(295), (function() { return this; }()), __webpack_require__(296)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getQuery = exports.getQuery = function getQuery(name, url) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(294), __webpack_require__(304)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html {\n  font-family: \"Segoe UI\", \"Lucida Grande\", Helvetica, Arial, FreeSans,Microsoft YaHei,Arimo, \"Droid Sans\", \"wenquanyi micro hei\", \"Hiragino Sans GB\", \"Hiragino Sans GB W3\", FontAwesome, sans-serif; }\n\n.nav {\n  position: fixed;\n  background-color: white;\n  padding-top: 20px;\n  padding-bottom: 20px;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  border-bottom-style: solid;\n  border-bottom-color: #f5f5f5;\n  border-bottom-width: 1.5px;\n  z-index: 1000; }\n\n.title {\n  text-align: center;\n  font-weight: bolder; }\n\n.disable {\n  display: none; }\n\n.button {\n  color: #2ebaa3;\n  border-color: #2ebaa3;\n  border-style: solid;\n  border-width: 1px;\n  background-color: white;\n  padding: 7px 12px;\n  border-radius: 3px; }\n\n.button-active {\n  color: white;\n  background-color: #2ebaa3; }\n\n.sub {\n  width: 90px;\n  font-size: 16px;\n  justify-content: flex-end; }\n\n.number {\n  display: flex;\n  font-size: 16px;\n  color: #bdc3c7; }\n\n.tabs {\n  position: fixed;\n  background-color: white;\n  height: 50px;\n  bottom: 0;\n  width: 100%;\n  display: flex;\n  align-items: center; }\n\n.tab {\n  flex: 1;\n  font-size: 28px;\n  text-align: center; }\n\n.tab a {\n  color: #bdc3c7; }\n\n.hasMore {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding-top: 10px; }\n\n.noMore {\n  color: #bdc3c7;\n  padding-top: 10px; }\n\nbody {\n  background-color: white; }\n\n.title {\n  font-size: 18px; }\n\n.container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding-top: 70px;\n  padding-bottom: 65px;\n  padding-left: 30px;\n  padding-right: 30px; }\n\n.list {\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n  padding-top: 8px; }\n\n.channel {\n  background-color: white;\n  display: flex;\n  flex-direction: column;\n  border-radius: 5px;\n  border: 1px solid #bdc3c7;\n  margin-bottom: 10px; }\n\n.header {\n  padding: 12px;\n  display: flex;\n  flex-direction: row;\n  flex: auto;\n  border-bottom: solid;\n  border-bottom-width: 1px;\n  border-bottom-color: #ecf0f1;\n  border-top-left-radius: 5px;\n  border-top-right-radius: 5px;\n  position: relative; }\n\n.header-left {\n  display: flex;\n  flex: 5;\n  flex-direction: column;\n  padding-left: 5px;\n  padding-right: 100px; }\n\n.name {\n  font-size: 20px;\n  font-weight: bolder;\n  padding-bottom: 8px; }\n\n.name a {\n  color: black;\n  text-decoration: none; }\n\n.number {\n  display: flex;\n  font-size: 16px;\n  color: #bdc3c7; }\n\n.header-right {\n  position: absolute;\n  right: 0;\n  top: 0;\n  padding-top: 15px;\n  padding-right: 15px; }\n\n.footer {\n  min-height: 35px;\n  padding: 12px;\n  flex: auto;\n  font-size: 16px;\n  color: #95a5a6;\n  background-color: #fbfbfb;\n  border-bottom-right-radius: 5px;\n  border-bottom-left-radius: 5px;\n  line-height: 28px;\n  letter-spacing: 0.5px; }\n", ""]);
