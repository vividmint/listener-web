...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2.default.getJSON(host + "users/" + account + "/channels?limit=" + limit + "&start=" + start, function (data, status) {
	    if (status != "success") {
	        alert(data.id);
	        return;
	    }
	...
	(0, _jquery2.default)(".more").on("click", function () {
	    _jquery2.default.getJSON(host + "users/" + account + "/channels?limit=" + limit + "&start=" + start, function functionName(data) {
	        console.log(data);
