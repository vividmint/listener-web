...
/***/ function(module, exports, __webpack_require__) {
	...
	var alias = (0, _common.getQuery)('id'),
	    account = "18613227075";
	(0, _common.request)("channels/" + alias + "?user_id=" + account).then(function (data) {
	    console.log(data);
	    var buttonText = "",
	        buttonActive = "";
	    ...
	    (0, _jquery2.default)(".detail").html(detailHtml);
	}).catch(function (e) {
	    (0, _jquery2.default)(".detail").text("没有找到该主题！");
	});
	(0, _jquery2.default)(".container").on("click", ".sub", function () {
	    (0, _jquery2.default)(".sub").html('<i class="fa fa-spinner fa-spin fa-fw"></i>');
	    var isSub = (0, _jquery2.default)(".sub").hasClass("button-active");
	    console.log(isSub);
	    if (isSub) {
	        (0, _common.request)("channels/" + alias + "/subscriptions", "delete", {
	            "user_id": account
	        }).then(function (data) {
	            (0, _jquery2.default)(".sub").removeClass("button-active");
	            (0, _jquery2.default)(".sub").text("+ 监听");
	            console.log(data);
	        }).catch(function (error) {
	            console.log(error);
	        });
	    } else {
	        (0, _common.request)("channels/" + alias + "/subscriptions", "post", {
	            "user_id": account,
	            "allow_push": true
	        }).then(function (data) {
	            (0, _jquery2.default)(".sub").addClass("button-active");
	            (0, _jquery2.default)(".sub").text("√ 已监听");
	            console.log(data);
	        }).catch(function (error) {
	            console.log(error);
	        });
